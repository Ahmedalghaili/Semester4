...
export default function RegistrationA() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('http://localhost/semester4/my-project/src/dashboard/register.php', {
        name,
        email,
        password
      });
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Or{' '}
              <Link to="/LoginA" className="font-medium text-indigo-600 hover:text-indigo-500">
